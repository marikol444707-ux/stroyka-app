...
### 🟡 Ф1.2 — Доделка реорганизации (что осталось от Ф1) [S]

- [ ] Объединить дневной журнал и таблицу КС-6а в одной вкладке через переключатель (сейчас табличный — через модалку)
- [ ] Объединить две точки печатных форм по объекту (Документы + Бухгалтерия)
