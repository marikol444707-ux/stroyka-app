...
- [ ] Task A7: After Tasks E3-E6, run deterministic estimate-revision impact analysis in shadow mode across assignments, materials, supply, warehouse and project economics; do not expose recommendations or mutate business records.
  ...
  - [ ] Task A7.3: Project material, open-supply and warehouse exposure from exact estimate coordinates, saved allocations, receipt lines, lots and movements; uncertain lineage becomes a fixed review reason. The two inert operator increments are implemented and verified locally; production deployment and exact-source evidence remain pending.
