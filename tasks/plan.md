...
- [ ] Следующий блок: допоставка остатка по тому же КП после частичной приёмки. Сейчас UI требует новую заявку и показывает «В пути» после принятой партии.
- [ ] По завершении проверки закрыть тестовые документы штатно: объект99, смета87, заявка879, КП70, счёт144 (не оплачивать), поставка16, складская накладная166, материал368 (1шт).
