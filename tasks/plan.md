...
- [ ] Task M7f2: Reads, mutations and approval/invite/transfer workflows are live. Both project-creation URLs now share a stored-owner implementation (`9c7fa23b`; `41` focused and `642` full backend tests); production deploy, protected smoke and strict audit remain.
