...
- [ ] Task A1.4.4: Deploy queued-job cancellation and verify the API route, tenant denial paths, transactional audit, queued success and running conflict in production.
