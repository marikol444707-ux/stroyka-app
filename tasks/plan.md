...
- [ ] Task M6.4l: Scope estimate-reconciliation CRUD and its unexpected-work candidates through verified estimate parents instead of project names. Read-only ownership audit is ready; strict runtime is prepared locally but blocked on a clean production report.
