...
- [ ] Task M6.8b2: Add a guarded nullable owner migration for `api_errors`, accepting the exact production review set only by SHA. Implemented locally; release and production dry-run/apply remain pending.
