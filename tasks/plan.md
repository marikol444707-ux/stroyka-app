...
- [ ] Task M7i2: Build a guarded dry-run cleanup plan for the exact `25` orphan child rows while preserving terminal legacy MAX outbox `30/32/34/36/38`; keep apply as a separate explicit step protected by count and SHA.
