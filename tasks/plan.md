...
- [ ] Task M6.4h: Scope only `GET /unexpected-works` by stored company/project ownership and effective tenant role while preserving its response shape and every mutation route.
