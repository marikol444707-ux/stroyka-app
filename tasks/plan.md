...
- [ ] Task M6.2d7: Enable protected preview only for the two master work-submission photo fields with `context="work-journal"`, preserving their compatibility upload contract and every other master form.
