...
- [ ] Task M6.6c1: Add and guarded-backfill `ai_findings.company_id/project_id` through exact project and supported linked-entity parents without changing findings runtime. Implemented locally; production dry-run/apply pending.
