...
- [ ] P12.1: полный frontend/build, выпуск и рабочая проверка сбоя/восстановления без изменения данных.
- [ ] P12.2: проверить единую выдачу вложений и права на файлы в цепочке КП/поставок/претензий.
