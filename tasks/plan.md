...
- [ ] Task M7i1: Diagnose the `25` orphaned core-supply children and their downstream references read-only; do not delete, guess or reassign rows before an exact guarded remediation plan.
