...
- [ ] Task A4.2.1: Add a dry-run-by-default, explicit-apply producer that enqueues at most one deterministic daily brief for one active company and one explicit date. Do not run the worker, schedule, model, MAX or bulk companies in this slice.
