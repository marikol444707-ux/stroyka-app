...
def generate_hidden_works_detection_legacy(
    prompt,
    instructions,
    yandex_api_key,
    yandex_folder_id,
...
def generate_hidden_works_detection_gateway(
    prompt,
    instructions,
    yandex_api_key,
    yandex_folder_id,
...
def generate_hidden_works_detection(
    ...
    if model_gateway_enabled is True:
        return generate_hidden_works_detection_gateway(*arguments)
    return generate_hidden_works_detection_legacy(*arguments)
