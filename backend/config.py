...
MAX_BOT_API_BASE = os.getenv("MAX_BOT_API_BASE", "https://platform-api2.max.ru").rstrip("/")
MAX_FILE_DOWNLOAD_PATH_TEMPLATE = os.getenv("MAX_FILE_DOWNLOAD_PATH_TEMPLATE", "").strip()
...
PUBLIC_SITE_LEAD_UPLOADS_ENABLED = os.getenv("PUBLIC_SITE_LEAD_UPLOADS_ENABLED", "false").lower() in ("1", "true", "yes")
PUBLIC_SITE_COMPANY_ID = env_int("PUBLIC_SITE_COMPANY_ID", 1)
