...
check_not_spa "agent jobs route" "/agent-jobs" "401 403"
check_not_spa "agent job detail route" "/agent-jobs/1" "401 403"
check_post_not_spa "agent job cancel route" "/agent-jobs/1/cancel" "401 403"
check_not_spa "AI tasks route" "/ai-tasks" "401 403"
check_not_spa "project events route" "/project-events?project_name=smoke" "401 403"
check_not_spa "material packaging rules route" "/material-packaging-rules" "401 403"
check_post_not_spa "material packaging correction preview route" "/material-packaging-corrections/preview" "401 403 422 429"
check_not_spa "material packaging reviews route" "/material-packaging-reviews" "401 403"
