...
addHome('h1-02', 'Дом 128 м2 с панорамной гостиной', '128 м2', '1 этаж', 15.9, 8.2, [
  ...
  r(4.2, 0, 2.1, 2.1, 'Санузел', 'bath', { tile: true }),
  r(6.3, 0, 2.2, 2.1, 'Гардероб', 'service', { fixtures: [{ type: 'wardrobe', x: .12, y: .18, w: .76, h: .46 }] }),
  r(8.5, 0, 7.4, 5.4, 'Панорамная гостиная', 'living', { windows: ['top', 'right', 'bottom'] }),
  r(0, 3.2, 3.8, 3.2, 'Спальня', 'bed', { windows: ['left'] }),
  r(3.8, 3.2, 3.1, 3.2, 'Спальня', 'bed'),
  r(6.3, 2.1, 2.2, 2, 'Котельная', 'service'),
  r(6.9, 4.1, 1.6, 2.3, 'Санузел', 'bath', { tile: true }),
  r(3.8, 6.4, 4.7, 1.6, 'Прихожая / холл', 'hall'),
], [r(10.1, 5.4, 4.8, 2, 'Панорамная терраса', 'terrace')], { dimX: '15,9 м', dimY: '8,2 м' });
...
addHome('h1-03', 'L-образный дом 145 м2', '145 м2', '1 этаж', 14.6, 10.2, [
  ...
  r(0, 6.3, 3.2, 3.2, 'Спальня', 'bed', { windows: ['left', 'bottom'] }),
  r(3.2, 6.3, 2.1, 2.2, 'Санузел', 'bath', { tile: true }),
  r(5.3, 6.3, 2.4, 3.2, 'Постирочная', 'service'),
  r(8.7, 4.7, 2.6, 2.4, 'Котельная', 'service'),
], [r(7.7, 7.1, 5.2, 2.6, 'Внутренняя терраса', 'terrace')], { dimX: '14,6 м', dimY: '10,2 м' });
...
addTwoFloor('h2-01', 'Дом 117 м2 с террасой и балконом', '117 м2', 'терраса и балкон', 10.9, 8.2, [
  r(0, 0, 2.2, 2.1, 'Тамбур', 'hall'),
  r(2.2, 0, 1.7, 2.1, 'Санузел', 'bath', { tile: true }),
  r(3.9, 0, 2.1, 2.1, 'Лестница', 'hall', { fixtures: [{ type: 'stairs', x: .18, y: .13, w: .64, h: .72 }] }),
  r(6, 0, 2.1, 2.1, 'Котельная', 'service', { windows: ['top'] }),
  r(8.1, 0, 2.8, 2.1, 'Кабинет / гостевая', 'work', { windows: ['top'] }),
  r(0, 2.1, 3.2, 5.4, 'Холл / хранение', 'hall'),
  r(3.2, 2.1, 7.7, 5.4, 'Кухня-гостиная', 'living', { windows: ['right', 'bottom'] }),
], [
  r(0, 0, 3.2, 3.1, 'Мастер-спальня', 'bed', { windows: ['top'] }),
  r(3.2, 0, 2.8, 3.1, 'Спальня', 'bed', { windows: ['top'] }),
  r(6, 0, 2.8, 3.1, 'Спальня', 'bed', { windows: ['top'] }),
  r(8.8, 0, 2.1, 3.1, 'Лестница', 'hall', { fixtures: [{ type: 'stairs', x: .18, y: .16, w: .64, h: .64 }] }),
  r(0, 3.1, 2.2, 2.2, 'Санузел', 'bath', { tile: true }),
  r(2.2, 3.1, 2.1, 2.2, 'Гардероб', 'service', { fixtures: [{ type: 'wardrobe', x: .16, y: .18, w: .68, h: .5 }] }),
  r(4.3, 3.1, 4.5, 2.2, 'Холл', 'hall'),
], [r(4, 7.5, 5.2, 1.4, 'Терраса', 'terrace')], [r(6.2, 5.3, 3.4, 1.3, 'Балкон', 'terrace')], { dimX: '10,9 м', dimY: '8,2 м' });

addTwoFloor('h2-02', 'Дом 174 м2 с четырьмя спальнями', '174 м2', '4 спальни и балконы', 14.1, 8.6, [
  r(0, 0, 3.2, 2.5, 'Кабинет', 'work', { windows: ['top'] }),
  r(3.2, 0, 2, 2.5, 'Санузел', 'bath', { tile: true }),
  r(5.2, 0, 2.2, 2.5, 'Лестница', 'hall', { fixtures: [{ type: 'stairs', x: .2, y: .13, w: .6, h: .72 }] }),
  r(7.4, 0, 2.4, 2.5, 'Котельная', 'service', { windows: ['top'] }),
  r(9.8, 0, 4.3, 2.5, 'Кухня', 'kitchen', { windows: ['top', 'right'] }),
  r(0, 2.5, 5.2, 5.5, 'Холл / гардероб', 'hall'),
  r(5.2, 2.5, 8.9, 5.5, 'Гостиная-столовая', 'living', { windows: ['right', 'bottom'] }),
], [
  r(0, 0, 3.2, 3.1, 'Мастер-спальня', 'bed', { windows: ['top'] }),
  r(3.2, 0, 3, 3.1, 'Спальня', 'bed', { windows: ['top'] }),
  r(6.2, 0, 3, 3.1, 'Спальня', 'bed', { windows: ['top'] }),
  r(9.2, 0, 3.1, 3.1, 'Спальня', 'bed', { windows: ['top'] }),
  r(12.3, 0, 1.8, 3.1, 'Лестница', 'hall', { fixtures: [{ type: 'stairs', x: .18, y: .16, w: .64, h: .64 }] }),
  r(0, 3.1, 2.2, 2.3, 'Санузел', 'bath', { tile: true }),
  r(2.2, 3.1, 2.2, 2.3, 'Постирочная', 'service'),
  r(4.4, 3.1, 4.8, 2.3, 'Холл', 'hall'),
], [r(6.2, 8, 5.8, 1.4, 'Терраса', 'terrace')], [r(.6, 5.4, 2.8, 1.2, 'Балкон', 'terrace'), r(9.2, 5.4, 2.8, 1.2, 'Балкон', 'terrace')], { dimX: '14,1 м', dimY: '8,6 м' });

addTwoFloor('h2-03', 'Дом 235 м2 с террасой и балконом', '235 м2', 'мастер-спальня', 15.9, 8.9, [
  r(0, 0, 3.3, 2.7, 'Кабинет', 'work', { windows: ['top'] }),
  r(3.3, 0, 2.2, 2.7, 'Санузел', 'bath', { tile: true }),
  r(5.5, 0, 2.4, 2.7, 'Лестница', 'hall', { fixtures: [{ type: 'stairs', x: .2, y: .13, w: .6, h: .72 }] }),
  r(7.9, 0, 2.5, 2.7, 'Котельная', 'service', { windows: ['top'] }),
  r(10.4, 0, 5.5, 2.7, 'Кухня', 'kitchen', { windows: ['top', 'right'] }),
  r(0, 2.7, 5.5, 5.5, 'Прихожая / хранение', 'hall'),
  r(5.5, 2.7, 10.4, 5.5, 'Большая гостиная', 'living', { windows: ['right', 'bottom'] }),
], [
  r(0, 0, 3.7, 3.2, 'Мастер-спальня', 'bed', { windows: ['top'] }),
  r(3.7, 0, 2.2, 3.2, 'Гардероб', 'service', { fixtures: [{ type: 'wardrobe', x: .16, y: .18, w: .68, h: .5 }] }),
  r(5.9, 0, 2.2, 3.2, 'Санузел', 'bath', { tile: true }),
  r(8.1, 0, 2.8, 3.2, 'Спальня', 'bed', { windows: ['top'] }),
  r(10.9, 0, 2.7, 3.2, 'Спальня', 'bed', { windows: ['top'] }),
  r(13.6, 0, 2.3, 3.2, 'Лестница', 'hall', { fixtures: [{ type: 'stairs', x: .2, y: .13, w: .6, h: .72 }] }),
  r(0, 3.2, 3.7, 2.7, 'Спальня', 'bed', { windows: ['left'] }),
  r(3.7, 3.2, 2.2, 2.7, 'Санузел', 'bath', { tile: true }),
  r(5.9, 3.2, 2.2, 2.7, 'Постирочная', 'service'),
  r(8.1, 3.2, 5.5, 2.7, 'Семейный холл', 'hall'),
], [r(7, 8.2, 7.2, 1.5, 'Терраса', 'terrace')], [r(8.2, 5.9, 4.8, 1.3, 'Балкон', 'terrace')], { dimX: '15,9 м', dimY: '8,9 м' });
...
addTwoFloor('gar-01', 'Дом 136 м2 с гаражом и террасой', '136 м2', 'гараж 1 авто', 12.8, 8.4, [
  r(0, 0, 3.7, 4.8, 'Гараж', 'garage', { windows: ['top'] }),
  r(3.7, 0, 2.1, 2.4, 'Котельная', 'service'),
  r(5.8, 0, 1.9, 2.4, 'Санузел', 'bath', { tile: true }),
  r(7.7, 0, 2.1, 2.4, 'Лестница', 'hall', { fixtures: [{ type: 'stairs', x: .2, y: .13, w: .6, h: .72 }] }),
  r(9.8, 0, 3, 2.4, 'Кухня', 'kitchen', { windows: ['top', 'right'] }),
  r(0, 4.8, 3.7, 3, 'Прихожая / хранение', 'hall'),
  r(3.7, 2.4, 9.1, 5.4, 'Гостиная-столовая', 'living', { windows: ['right', 'bottom'] }),
], [
  r(0, 0, 3.2, 3.1, 'Мастер-спальня', 'bed', { windows: ['top'] }),
  r(3.2, 0, 3, 3.1, 'Спальня', 'bed', { windows: ['top'] }),
  r(6.2, 0, 3, 3.1, 'Спальня', 'bed', { windows: ['top'] }),
  r(9.2, 0, 3.6, 3.1, 'Лестница / холл', 'hall', { fixtures: [{ type: 'stairs', x: .25, y: .16, w: .48, h: .64 }] }),
  r(0, 3.1, 2.2, 2.2, 'Санузел', 'bath', { tile: true }),
  r(2.2, 3.1, 2.2, 2.2, 'Гардероб', 'service'),
  r(4.4, 3.1, 4.8, 2.2, 'Холл', 'hall'),
], [r(6.5, 7.8, 4.8, 1.4, 'Терраса', 'terrace')], [], { dimX: '12,8 м', dimY: '8,4 м' });

addTwoFloor('gar-02', 'Дом 193 м2 с гаражом и плоской кровлей', '193 м2', 'гараж и кровля-терраса', 15.1, 8.7, [
  r(0, 0, 3.9, 4.9, 'Гараж', 'garage', { windows: ['top'] }),
  r(3.9, 0, 2.2, 2.5, 'Котельная', 'service'),
  r(6.1, 0, 2, 2.5, 'Санузел', 'bath', { tile: true }),
  r(8.1, 0, 2.2, 2.5, 'Лестница', 'hall', { fixtures: [{ type: 'stairs', x: .2, y: .13, w: .6, h: .72 }] }),
  r(10.3, 0, 4.8, 2.5, 'Кабинет', 'work', { windows: ['top', 'right'] }),
  r(0, 4.9, 4.2, 3.1, 'Прихожая / склад', 'hall'),
  r(4.2, 2.5, 10.9, 5.5, 'Кухня-гостиная', 'living', { windows: ['right', 'bottom'] }),
], [
  r(0, 0, 3.6, 3.2, 'Мастер-спальня', 'bed', { windows: ['top'] }),
  r(3.6, 0, 2.2, 3.2, 'Гардероб', 'service', { fixtures: [{ type: 'wardrobe', x: .16, y: .18, w: .68, h: .5 }] }),
  r(5.8, 0, 2.2, 3.2, 'Санузел', 'bath', { tile: true }),
  r(8, 0, 3, 3.2, 'Спальня', 'bed', { windows: ['top'] }),
  r(11, 0, 2.9, 3.2, 'Спальня', 'bed', { windows: ['top'] }),
  r(13.9, 0, 1.2, 3.2, 'Лестница', 'hall', { fixtures: [{ type: 'stairs', x: .08, y: .16, w: .84, h: .64 }] }),
  r(0, 3.2, 3.6, 2.4, 'Холл', 'hall'),
  r(3.6, 3.2, 4.4, 2.4, 'Семейная зона', 'living', { windows: ['bottom'] }),
], [r(5.4, 8, 5.8, 1.4, 'Терраса', 'terrace')], [r(8, 5.6, 5.8, 1.6, 'Кровля-терраса', 'terrace')], { dimX: '15,1 м', dimY: '8,7 м' });

addTwoFloor('gar-03', 'Дом 218 м2 с гаражом и мастер-спальней', '218 м2', 'гараж и мастерская', 16.7, 8.8, [
  r(0, 0, 3.8, 4.6, 'Гараж', 'garage', { windows: ['top'] }),
  r(3.8, 0, 2.7, 4.6, 'Мастерская', 'work', { fixtures: [{ type: 'desks', x: .1, y: .2, w: .75, h: .5, rows: 1, cols: 2 }], windows: ['top'] }),
  r(6.5, 0, 2.2, 2.4, 'Котельная', 'service'),
  r(8.7, 0, 2.1, 2.4, 'Санузел', 'bath', { tile: true }),
  r(10.8, 0, 2.2, 2.4, 'Лестница', 'hall', { fixtures: [{ type: 'stairs', x: .2, y: .13, w: .6, h: .72 }] }),
  r(13, 0, 3.7, 2.4, 'Гостевая', 'bed', { windows: ['top', 'right'] }),
  r(0, 4.6, 6.5, 3.5, 'Прихожая / хранение', 'hall'),
  r(6.5, 2.4, 10.2, 5.7, 'Каминная гостиная', 'living', { windows: ['right', 'bottom'] }),
], [
  r(0, 0, 3.7, 3.2, 'Мастер-спальня', 'bed', { windows: ['top'] }),
  r(3.7, 0, 2.2, 3.2, 'Гардероб', 'service', { fixtures: [{ type: 'wardrobe', x: .16, y: .18, w: .68, h: .5 }] }),
  r(5.9, 0, 2.2, 3.2, 'Санузел', 'bath', { tile: true }),
  r(8.1, 0, 2.8, 3.2, 'Спальня', 'bed', { windows: ['top'] }),
  r(10.9, 0, 2.8, 3.2, 'Спальня', 'bed', { windows: ['top'] }),
  r(13.7, 0, 3, 3.2, 'Спальня', 'bed', { windows: ['top'] }),
  r(0, 3.2, 2.3, 2.4, 'Санузел', 'bath', { tile: true }),
  r(2.3, 3.2, 2.2, 2.4, 'Постирочная', 'service'),
  r(4.5, 3.2, 2.3, 2.4, 'Лестница', 'hall', { fixtures: [{ type: 'stairs', x: .2, y: .13, w: .6, h: .72 }] }),
  r(6.8, 3.2, 7.4, 2.4, 'Семейный холл', 'hall'),
], [r(8.1, 8.1, 5.4, 1.4, 'Терраса', 'terrace')], [], { dimX: '16,7 м', dimY: '8,8 м' });
