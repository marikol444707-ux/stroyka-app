    ...
    return (
      <AppMasterCabinetRoute
        ...
        data={{
          ...
          capMaterialWriteoffQty: materialRuntime.capMaterialWriteoffQty,
        ...
        actions={{
          ...
          applyMaterialOverNormReason: actions.applyMaterialOverNormReason,
          ...
          getProjectWorkPackageOptions: projectRuntime.getProjectWorkPackageOptions,
          ...
          materialNormOverrunReason: actions.materialNormOverrunReason,
          materialWriteoffBlockMessage: actions.materialWriteoffBlockMessage,
          prepareWorkMaterialGroups: actions.prepareWorkMaterialGroups,
