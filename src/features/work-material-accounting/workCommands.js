...
const commandPath = /^\/(work-journal(?:\/[1-9][0-9]*\/(?:material-corrections|material-defects(?:\/[1-9][0-9]*\/decisions)?))?|estimates\/[1-9][0-9]*|brigade-contracts\/[1-9][0-9]*\/acts(?:\/[1-9][0-9]*\/signature)?|brigade-payments)$/;
