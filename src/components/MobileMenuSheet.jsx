...
export default function MobileMenuSheet({showMobileMenu, setShowMobileMenu, menuItems, activePage, navigateTo, setActivePage, C}) {
  ...
  return (
    <>
      <div onMouseDown={e=>{e.preventDefault();setShowMobileMenu(false);}} style={{position:'fixed',top:0,left:0,right:0,bottom:'60px',backgroundColor:'rgba(0,0,0,0.5)',zIndex:299}}/>
      <div style={{position:'fixed',bottom:'60px',left:0,right:0,backgroundColor:C.bgWhite,borderRadius:'16px 16px 0 0',padding:'16px',zIndex:300,maxHeight:'60vh',overflowY:'auto',boxShadow:'0 -8px 30px rgba(0,0,0,0.15)',borderTop:'1.5px solid '+C.border}}>
