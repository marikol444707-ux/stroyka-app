  ...
  return (
    <div style={{backgroundColor:C.bgWhite,padding:compact?'10px 12px':'12px 24px',borderBottom:'1.5px solid '+C.border,display:activePage==='dashboard'?'none':'flex',alignItems:compact?'flex-start':'center',gap:compact?'8px':'15px',flexWrap:'wrap',flexShrink:0,boxShadow:'0 1px 3px rgba(0,0,0,0.04)',width:'100%',maxWidth:'100vw',minWidth:0,boxSizing:'border-box',overflowX:'hidden',justifyContent:compact?'flex-start':'space-between'}}>
      ...
      <div style={{position:'relative',display:'flex',gap:'8px',alignItems:'center',justifyContent:phoneLike?'flex-start':'flex-end',flexWrap:'wrap',marginLeft:phoneLike?0:'auto',width:phoneLike?'100%':'auto',maxWidth:'100%',minWidth:0,overflowX:'hidden'}}>
        ...
        <button onClick={()=>setShowQuickActions(true)} title='Быстрые действия' style={{...headerButtonStyle,background:'linear-gradient(135deg,#f97316,#ea580c)',border:'none',color:'white',fontWeight:'700',fontSize:phoneLike?'0':'13px',gap:'4px'}}>⚡ <span style={{fontSize:'13px',display:phoneLike?'none':'inline'}}>Быстро</span></button>
