...
export default function QuickActionsModal({
  ...
  const actions = [
    ...
    {icon:<ReceiptText size={24}/>,label:'Расход по объекту',color:'#8b5cf6',action:()=>{const visible=visibleActiveProjects(projects);setNewManualExpense({category:'materials',customCategory:'',projectName:'',amount:'',note:'',date:'',photoUrl:''});setAddExpenseProject(visible.length===1?visible[0].name:'__choose__');setShowQuickActions(false);},roles:['директор','зам_директора','бухгалтер']},
