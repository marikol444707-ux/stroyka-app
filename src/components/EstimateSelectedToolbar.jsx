...
import { ArrowLeft, Bot, Download, Eye, FileText, GitBranch, UserCheck, Users } from 'lucide-react';
...
export default function EstimateSelectedToolbar({
  ...
  return (
    <div style={{display:'flex',gap:'8px',marginBottom:'15px',alignItems:'center',flexWrap:'wrap'}}>
      ...
      {showLeadership && <button onClick={onOpenWorkAssignment} style={{...btnO,backgroundColor:'#16a34a'}}><UserCheck size={14}/>Назначить исполнителю</button>}
