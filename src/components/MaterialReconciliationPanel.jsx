  ...
  return (
    <div style={{...card,padding:'14px',marginBottom:'14px',backgroundColor:C.bgWhite,border:'1.5px solid '+C.accentBorder}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(120px,1fr))',gap:'8px',marginBottom:'12px'}}>
        ...
        <div style={{padding:'10px',backgroundColor:summary.reviewRows.length?C.warningLight:C.bg,borderRadius:'8px',border:'1px solid '+(summary.reviewRows.length?C.warningBorder:C.border)}}><p style={{color:summary.reviewRows.length?C.warning:C.textSec,fontSize:'10px',margin:'0 0 3px'}}>Проверить</p><b style={{color:summary.reviewRows.length?C.warning:C.text,fontSize:'15px'}}>{summary.reviewRows.length}</b></div>
