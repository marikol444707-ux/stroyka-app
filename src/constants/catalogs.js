...
export const VAT_OPTIONS = ['Без НДС','С НДС 20%','С НДС 22%'];

export const PAYMENT_TYPES = ['Наличный расчёт','Безналичный расчёт','Перевод на карту','Аванс наличный','Аванс безналичный'];

export const ESTIMATE_PACKAGES = ['Основная','Общестрой','Отопление','ВК / канализация','Электрика','Слаботочка','Вентиляция','Кондиционирование','Отделка','Благоустройство'];
...
export const CRM_STAGES = ['Новый','На проверке','Квалификация','Замер / ТЗ','Смета / КП','Договор','Передан в объект','Одобрен как поставщик','Одобрен как исполнитель','Отказ'];
