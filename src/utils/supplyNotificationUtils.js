const EMAIL_LABELS = {
  'Email отклонён: повтор разрешён': 'Письмо отклонено сервером; доступен явный повтор',
  'Отправлено': 'Передано SMTP',
  'В очереди email': 'В очереди email',
  'Передача email: результат не подтверждён': 'Результат передачи email не подтверждён; автоматический повтор отключён',
  'Нет email': 'Нет email',
...
const MAX_LABELS = {
  ...
  sending: 'Результат передачи MAX не подтверждён; повтор отключён',
