...
function App() {
  ...
  const setInitialDataLoaded = appMainState?.setInitialDataLoaded;
  ...
  useEffect(() => {
    ...
    if (typeof setInitialDataLoaded === 'function') {
      setInitialDataLoaded(false);
    }
  }, [companyContext.mode, companyContext.selectedCompanyId, setInitialDataLoaded]);
